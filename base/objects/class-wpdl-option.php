...
if ( ! class_exists( 'WPDL_Option' ) ) {
	 ...
	 */
	class WPDL_Option implements WPDL_Object {
		...
		public static function factory( string $option_group, string $option_name ): ?WPDL_Option {
			...
			if ( isset( $wp_registered_setting[ $option_name ] ) ) {
				...
				if ( ! isset ( static::$objects[ $option_name ] ) ) {
					static::$objects[ $option_name ] = new WPDL_Option( $option_group, $option_name, $args );
				}
